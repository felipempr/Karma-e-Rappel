...
#define MISL 100.0 //era 0.1
#define MISI 100.0
#define MILI 100.0

#define EPSILONSL 0.0002//era 0.0005
#define EPSILONSI 0.0002
#define EPSILONLI 0.0002
...
#define TELX 250	//total de elementos na direção x 1250
#define TELY 250	//total de elementos na direção y 1250
//PARÂMETROS DE TEMPO
#define Ttot 0.2	//tempo total da simulação 1920
#define dt 0.000001		//tamanho do intervalo entre os passos de tempo 0.02
//PARÂMETROS DE SIMULAÇÃO
#define EXISTE 0.9999	//valor da variável de fase no estado sólido
#define N_EXISTE 0.00005	//valor da variável de fase no estado líquido
