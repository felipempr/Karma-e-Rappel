...
#define compL 600 	//comprimento do domínio x/d0=902  COMPRIMENTO NOVO =10X DIAMETRO DA PARTICULA E x*=x/d0 (MANTIVE ANTIGO)
#define R 20.1//20.22//16.84		//raio inicial
#define TELX 600	//total de elementos na direção x 1250 deltax*=1,92, mantendo 800 eu calculo o tamanho do domínio (MANTIVE ANTIGO)
#define TELY 600	//total de elementos na direção y 1250
//PARÂMETROS DE TEMPO
#define Ttot 150000//200000.0//40	//tempo total da simulação 3750 depois 938
...
#define l 100//183 //largura da particula
#define h 10.3//8.7 // altura acima da superficie da partícula
#define PHI0 0.0
#define TAN1 0.84
#define TAN2 0.84
//#define SEN 0.866